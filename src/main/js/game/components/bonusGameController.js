define(require => {
    ...
    function init() {
        ...
        displayList.bonusSpinButtonAnim.visible = false;
    ...
    function matchWheel() {
        switch (wheelIndex) {
            case 0: {
                target = displayList.bonusWheelBottomBackground;
                break;
            }
            case 1: {
                target = displayList.bonusWheelMiddleBackground;
                break;
            }
            case 2: {
                target = displayList.bonusWheelTopBackground;
                break;
            }
        }
    }
        ...
        if (bonusArray.length === 1) {
            ...
            switch (bonusArray[0]) {
                ...
                case 'Z': {
                    ...
                    audio.play('arrowWin');
                    Tween.delayedCall(1.75,spinData);
                    break;
                }
                default: {
                    Tween.delayedCall(2,spinData);
                    audio.play('cash');
                    break;
                }
            }
