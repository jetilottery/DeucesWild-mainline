define(function(require) {
  ...
  function gameInit() {
    ...
    if (config.overrideMaxButtonWidth) {
      ...
      displayList.buyButton.label.maxWidth = config.overrideButtonWidthValue;
      displayList.tryButton.label.maxWidth = config.overrideButtonWidthValue;
    }

    // Once everything is initialized continue to next state
    setTimeout(gameFlow.next, 500);
  }
